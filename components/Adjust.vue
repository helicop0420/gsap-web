    ...
    mounted() {			
        ...
        scrollTrigger: {
          ...
          scrub: true,
			...
			.add('image-up')
			.to(".img-adjust", {top: '2%', duration: 1 }, "image-up")
			.to(".pta-text", {opacity: 1}, "image-up")
			.to(".pta-section", {top: '-100vh', opacity: 0})
        ...
        scrollTrigger: {
          ...
          // ease: gsap.Power3.easeOut
			...
			.to(".first-marker", {opacity:1, duration: 3, ease: "power2.out"})
			.add("ballon-move-1")
